...
public class TBEnterpriseSortOrderingsLabelProvider extends TablePropertyLabelProvider {
	public TBEnterpriseSortOrderingsLabelProvider(String tableName) {
		super(tableName);
	}

	public Image getColumnImage(Object _element, String _property) {
		TBEnterpriseSortOrdering sortOrdering = (TBEnterpriseSortOrdering) _element;
		Image image = null;
		if (TBEnterpriseSortOrdering.ASCENDING.equals(_property)) {
	...
	public String getColumnText(Object _element, String _property) {
		...
		if (TBEnterpriseSortOrdering.ASCENDING.equals(_property)) {
			// DO NOTHING
		} else if (TBEnterpriseSortOrdering.CASE_INSENSITIVE.equals(_property)) {
