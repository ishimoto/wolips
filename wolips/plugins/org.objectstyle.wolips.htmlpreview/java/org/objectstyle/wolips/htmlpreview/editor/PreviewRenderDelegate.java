...
import org.objectstyle.wolips.htmlpreview.editor.tags.TBStyleSheetTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBCheckBoxTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBConditionalTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBGenericContainerTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBGenericElementTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBHyperlinkTagDelegate;
...
import org.objectstyle.wolips.htmlpreview.editor.tags.TBTextFieldTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBTextTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBBrowserTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBComponentContentTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBPopUpButtonTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBRepetitionTagDelegate;
import org.objectstyle.wolips.htmlpreview.editor.tags.TBSubmitButtonTagDelegate;
...
public class PreviewRenderDelegate implements RenderDelegate {
	...
	public PreviewRenderDelegate(WodParserCache cache) {
		...
		_tagDelegates.put("TBComponentContent", new TBComponentContentTagDelegate());
		_tagDelegates.put("TBRepetition", new TBRepetitionTagDelegate());
		_tagDelegates.put("TBGenericContainer", new TBGenericContainerTagDelegate());
		_tagDelegates.put("TBGenericElement", new TBGenericElementTagDelegate());
		_tagDelegates.put("TBTextField", new TBTextFieldTagDelegate());
		_tagDelegates.put("FocusTextField", new TBTextFieldTagDelegate());
		_tagDelegates.put("TBCheckBox", new TBCheckBoxTagDelegate());
		_tagDelegates.put("TBPopUp", new TBPopUpButtonTagDelegate());
		_tagDelegates.put("TBText", new TBTextTagDelegate());
		_tagDelegates.put("FocusText", new TBTextTagDelegate());
		_tagDelegates.put("TBSubmitButton", new TBSubmitButtonTagDelegate());
		_tagDelegates.put("TBHyperlink", new TBHyperlinkTagDelegate());
		_tagDelegates.put("TBImage", new TBImageTagDelegate());
		_tagDelegates.put("TBBrowser", new TBBrowserTagDelegate());
		_tagDelegates.put("TBStyleSheet", new TBStyleSheetTagDelegate());
